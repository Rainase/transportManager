...
class Crud_model extends CI_Model {
	...
	function get_product_info($client_id)
	{
		$query	=	$this->db->get_where('product' , array('client_id' => $client_id));
		return $query->result_array();
	}
	/////////TEACHER/////////////
	...
	function get_subjects_by_product_type($class)
	{
		$query	=	$this->db->get_where('subject' , array('class' => $class));
		return $query->result_array();
	}
	...
	function get_product_type_name($product_type_id)
	{
		...
		$res	=	$query->result_array();
		foreach($res as $row)
			return $row['get_product_type_name'];
	}
	
	function get_product_type_name_numeric($class)
	{
		$query	=	$this->db->get_where('product_type' , array('class' => $class));
		$res	=	$query->result_array();
		foreach($res as $row)
			return $row['name_numeric'];
	}
	
	function get_product_typees()
	{
		$query	=	$this->db->get('product_type' );
		return $query->result_array();
	}	
	function get_product_type_info($class)
	{
		$query	=	$this->db->get_where('product_type' , array('class' => $class));
		return $query->result_array();
	}
