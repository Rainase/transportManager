		...
		<section id="header" data-type="background" data-speed="10">
			...
			<!-- <div class="overlay"> -->
				...
				<div id="mobile-menu" class="list-group collapse text-center">
				  ...
				  <a href="<?php echo base_url();?>index.php?kuller/dashboard"> Login</a>
				</div>
					...
					<div class="container-transparent text-center">
						...
						<ul class="heronav right hidden-xs">
							...
							<li><a href="<?php echo base_url();?>index.php/login"class="list-group-item external">Login</a></li>
						</ul>
						<h1>
							<img src="<?php echo base_url(); ?>template/assets/img/logo/logo.png" height="50" alt="logo name">
						</h1>
			...
			<div class="container">
				<div class="row">
					<div class="col-sm-3 col-md-4">
						<div class="logo" >
							<a href="index.html"><img src="<?php echo base_url(); ?>template/assets/img/logo/logo.png" height="40" alt="logo name"/></a>
						</div>
					</div>
						...
						<div id="filter-items" class="row">
							<div class="col xs-12 col-sm-4 design item">
								<div class="filter-content">
									<img src="<?php echo base_url(); ?>template/assets/img/gallery/1.png" alt="" class="img-responsive" />
									<div class="image-content">
										<h4>Image Title</h4>
										<p class="hidden-xs hidden-sm">
											For faster mobile-friendly development, use these utility.
										</p>
										<a href="<?php echo base_url(); ?>template/assets/img/gallery/1.png" class="btn btn-sm btn-warning colorbox-button">Know More</a>
									</div>
								</div>
							</div>
							<div class="col xs-12 col-sm-4 videos item">
								<div class="filter-content">
									<img src="<?php echo base_url(); ?>template/assets/img/gallery/2.jpg" alt="" class="img-responsive" />
									<div class="image-content">
										<h4>Image Title</h4>
										<p class="hidden-xs hidden-sm">
											For faster mobile-friendly development, use these utility.
										</p>
										<a href="<?php echo base_url(); ?>template/assets/img/gallery/2.jpg" class="btn btn-sm btn-warning colorbox-button">Know More</a>
									</div>
								</div>
							</div>
							<div class="col xs-12 col-sm-4 banners item">
								<div class="filter-content">
									<img src="<?php echo base_url(); ?>template/assets/img/gallery/3.png" alt="" class="img-responsive" />
									<div class="image-content">
										<h4>Image Title</h4>
										<p class="hidden-xs hidden-sm">
											For faster mobile-friendly development, use these utility.
										</p>
										<a href="<?php echo base_url(); ?>template/assets/img/gallery/3.png" class="btn btn-sm btn-warning colorbox-button">Know More</a>
									</div>
								</div>
							</div>
							<div class="col xs-12 col-sm-4 videos item">
								<div class="filter-content">
									<img src="<?php echo base_url(); ?>template/assets/img/gallery/4.png" alt="" class="img-responsive" />
									<div class="image-content">
										<h4>Image Title</h4>
										<p class="hidden-xs hidden-sm">
											For faster mobile-friendly development, use these utility.
										</p>
										<a href="<?php echo base_url(); ?>template/assets/img/gallery/4.png" class="btn btn-sm btn-warning colorbox-button">Know More</a>
									</div>
								</div>
							</div>
							<div class="col xs-12 col-sm-4 design item">
								<div class="filter-content">
									<img src="<?php echo base_url(); ?>template/assets/img/gallery/5.png" alt="" class="img-responsive" />
									<div class="image-content">
										<h4>Image Title</h4>
										<p class="hidden-xs hidden-sm">
											For faster mobile-friendly development, use these utility.
										</p>
										<a href="<?php echo base_url(); ?>template/assets/img/gallery/5.png" class="btn btn-sm btn-warning colorbox-button">Know More</a>
									</div>
								</div>
							</div>
							<div class="col xs-12 col-sm-4 banners item">
								<div class="filter-content">
									<img src="<?php echo base_url(); ?>template/assets/img/gallery/8.png" alt="" class="img-responsive" />
									<div class="image-content">
										<h4>Image Title</h4>
										<p class="hidden-xs hidden-sm">
											For faster mobile-friendly development, use these utility.
										</p>
										<a href="<?php echo base_url(); ?>template/assets/img/gallery/8.png" class="btn btn-sm btn-warning colorbox-button">Know More</a>
									</div>
								</div>
							</div>
							<div class="col xs-12 col-sm-4 banners item">
								<div class="filter-content">
									<img src="<?php echo base_url(); ?>template/assets/img/gallery/7.jpg" alt="" class="img-responsive" />
									<div class="image-content">
										<h4>Image Title</h4>
										<p class="hidden-xs hidden-sm">
											For faster mobile-friendly development, use these utility.
										</p>
										<a href="<?php echo base_url(); ?>template/assets/img/gallery/7.jpg" class="btn btn-sm btn-warning colorbox-button">Know More</a>
									</div>
								</div>
							</div>
							<div class="col xs-12 col-sm-4 videos item">
						...
						<div class="carousel-caption">
						  <div class="row">
							<div class="circular col-md-6">
								<img src="<?php echo base_url(); ?>template/assets/img/testimonials/headshot1.jpg" alt="headshot #1" />
								<h3>Jane Richards</h3>
							...
							<div class="circular col-md-6">
								<img src="<?php echo base_url(); ?>template/assets/img/testimonials/headshot2.jpg" alt="headshot #2" />
								<h3>Shelly Doe</h3>
					...
					<div class="item">
					  <div class="container">
						<div class="carousel-caption">
						  <div class="row">
							<div class="circular col-md-6">
								<img src="<?php echo base_url(); ?>template/assets/img/testimonials/headshot3.jpg" alt="headshot #3" />
								<h3>Jim Doe</h3>
								<p>"He found himself at first in a thoroughly European quarter, the houses having low fronts, and being adorned with verandas, beneath which he caught glimpses of neat peristyles. This quarter occupied, with its streets, squares, docks, and warehouses."</p>
								<h4>www.thirdname.com</h4>
							</div>
							<div class="circular col-md-6">
								<img src="<?php echo base_url(); ?>template/assets/img/testimonials/headshot4.jpg" alt="headshot #4" />
								<h3>Kim Doe</h3>
								<p>"The civil Emperor, before the Mikado, the spiritual Emperor, absorbed his office in his own. The Carnatic anchored at the quay near the custom-house, in the midst of a crow-fluidd of ships bearing the flags of all nations. Passepartout went."</p>
					...
					<div class="item">
					  <div class="container">
						<div class="carousel-caption">
						  <div class="row">
							<div class="circular col-md-6">
								<img src="<?php echo base_url(); ?>template/assets/img/testimonials/headshot5.jpg" alt="headshot #4" />
								<h3>Liz Doe</h3>
								<p>"He found himself at first in a thoroughly European quarter, the houses having low fronts, and being adorned with verandas, beneath which he caught glimpses of neat peristyles. This quarter occupied, with its streets, squares, docks, and warehouses."</p>
								<h4>www.doefirst.com</h4>
							</div>
							<div class="circular col-md-6">
								<img src="<?php echo base_url(); ?>template/assets/img/testimonials/headshot6.jpg" alt="headshot #5" />
								<h3>Nat Doe</h3>
								<p>"The civil Emperor, before the Mikado, the spiritual Emperor, absorbed his office in his own. The Carnatic anchored at the quay near the custom-house, in the midst of a crow-fluidd of ships bearing the flags of all nations. Passepartout went."</p>
		...
		<section id="team" class="color-light text-center">
			<div class="container">
				...
				<div class="row">
					<div class="col-md-3 col-sm-6">
						<div class="team">
							<img alt="" src="<?php echo base_url(); ?>template/assets/img/img1.jpg">
							<h3>Ruby Burrow</h3>
					...
					<div class="col-md-3 col-sm-6">
						<div class="team">
							<img alt="" src="<?php echo base_url(); ?>template/assets/img/img2.jpg">
							<h3>Molly Debris</h3>
					...
					<div class="col-md-3 col-sm-6">
						<div class="team">
							<img alt="" src="<?php echo base_url(); ?>template/assets/img/img3.jpg">
							<h3>Dave Jose</h3>
							<h4>Brand Manager</h4>
					...
					<div class="col-md-3 col-sm-6">
						<div class="team">
							<img alt="" src="<?php echo base_url(); ?>template/assets/img/img4.jpg">
