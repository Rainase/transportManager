...
<head>
    ...
    <!-- UNIFORM -->
    <link rel="stylesheet" type="text/css" href="<?php echo base_url();?>template/assets/js/uniform/css/uniform.default.min.css" />
    <!-- ANIMATE -->
    <link rel="stylesheet" type="text/css" href="<?php echo base_url();?>template/assets/css/animatecss/animate.min.css" />
    <!-- FONTS -->
                    ...
                    <div class="row">
                        <div class="col-md-4 col-md-offset-4">
                            <div class="login-box-plain">
                                ...
                                <?php echo form_open('login' , array('role' => 'form', 'onsubmit' => 'return check_account_type()'));?>
                                  <div class="form-group">
                                    <label>Vali konto</label>
                                    <select id="account_selector" name="login_type" class="form-control">
                                        <option value="">--Vali--</option>
                                        <option value="kuller">Kuller</option>
                                        <option value="clients">Tellija</option>
                                    </select>
                                  </div>
                                  <div class="form-group">
